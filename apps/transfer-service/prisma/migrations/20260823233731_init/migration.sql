...
-- CreateIndex
CREATE INDEX "transfers_tenantId_customerId_createdAt_idx" ON "transfers"("tenantId", "customerId", "createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "transfers_tenantId_idempotencyKey_key" ON "transfers"("tenantId", "idempotencyKey");
